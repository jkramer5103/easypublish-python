...
os.system("curl -O https://raw.githubusercontent.com/jkramer5103/stuff/refs/heads/main/setup.py")
os.system("curl -O https://raw.githubusercontent.com/jkramer5103/stuff/refs/heads/main/build.py")
os.system(f"mkdir {name}")
os.chdir(name)
